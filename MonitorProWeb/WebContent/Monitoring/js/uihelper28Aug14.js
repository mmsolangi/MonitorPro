...
colsDetail = [{ title: "Detail ID", width: 100, dataIndx: "outcomeDTLID", editable: false },
                        { title: "Application Code", width: 100, dataIndx: "applicationCode" , editable: false },
                        { title: "Flow Name", width: 250, dataIndx: "slStepName" , editable: false },
                        { title: "Input Message", width: 0, dataIndx: "inputPayload", editable: true, hidden:true},
                        { title: "Output Message", width: 0, dataIndx: "outputPayload", editable: true,hidden: true},
                        { title: "Log Level", width: 100, dataIndx: "errorType", editable: false  },
                        { title: "Error Code", width: 100, dataIndx: "sourceSystemErrorCode" , editable: false },
                        { title: "Error Desc", width: 350, dataIndx: "sourceSystemErrorDesc", editable: false  }
  ...
  $(document).ready(function () {
    ...
    fromDate = fromDate.getMonth()+1 + '/' + fromDate.getDate() + '/' + fromDate.getFullYear() + ' ' + fromDate.getHours() + ':' + fromDate.getMinutes() 
    toDate = toDate.getMonth()+1 + '/' + toDate.getDate() + '/' + toDate.getFullYear() + ' ' + toDate.getHours() + ':' + toDate.getMinutes()        
		...
		close: function() {
            ...
            CriticalDataModel = {
                ...
                getUrl: function () {
                    ...
                    return { url: WCFServiceURL + "GetLogHeaders", data: "status=Critical Errors&currPage=1&pageSize=7&orderid=&tokenId=" + UIHelper.GetCookie("token") + "&sortBy=CLIENTREQUESTDATETIME&sortDirection=desc"
                ...
                colModel: [
                            ...
                            { "dataIndx": "lob", "title": "Bus. Object", "width": 100,
                                render: function (ui) {
                                    ...
                                    return "<a href=\"javascript:UIHelper.SaveFilter('" + cellData + "','"+rowData["outcomeHdrID"]+"','','','Critical Errors','','');UIHelper.LoadTab('" + cellData + "',true);\" title='view complete list of " + cellData + " critical issues'><font color='blue'>" + cellData + "</font></a>";
                            }
                            },
                            { "dataIndx": "outcomeHdrID", "title": "ID", "widthval": 100 },
