...
colsDetail = [{ title: "Detail ID", width: 100, dataIndx: "outcomeDTLID", editable: false },
                        ...
                        { title: "Flow Name", width: 150, dataIndx: "slStepName" , editable: false },
                        ...
                        { title: "Error Desc", width: 250, dataIndx: "sourceSystemErrorDesc", editable: false  }
                    ...
                    debugger;
                      ...
                      if ( bValid ) {
                        ...
                        $.ajax({
							...
							// UserLobs,
                            data: 'tokenId=' + UIHelper.GetCookie("token") + "&id=" + $("#UserID").val() + "&name=" + $("#Username").val() + "&password=" + $("#Password").val() + "&email=" + $("#Email").val() + "&status=" + $("#chkStatus").is(':checked') + "&userlobs=" + UserLobs,
