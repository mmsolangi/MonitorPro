...
public class LogHeaderDetail implements Serializable{
	...
	public String toString() {
		return "LogHeaderDetail [outcomeDTLID=" + outcomeDTLID
				+ ", slStepName=" + slStepName + ", sourceSystemErrorCode="
				+ sourceSystemErrorCode + ", sourceSystemErrorDesc="
				+ sourceSystemErrorDesc + ", inputPayload=" + inputPayload
				+ ", outputPayload=" + outputPayload + ", applicationCode="
				+ applicationCode + ", logLevel=" + logLevel
				+ ", executionSeq=" + executionSeq + ", debugEntry="
				+ debugEntry + ", server=" + server + ", entryTimeatstep="
				+ entryTimeatstep + ", exitTimeatstep=" + exitTimeatstep
				+ ", errorType=" + errorType + ", dbupdCreatedttm="
				+ dbupdCreatedttm + ", inputPayloaEenc="
				+ Arrays.toString(inputPayloaEenc) + ", outputPayloadEnc="
				+ Arrays.toString(outputPayloadEnc) + ", dbupdCreateusr="
				+ dbupdCreateusr + "]";
	}
